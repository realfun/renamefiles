...
1. Go to a directory and enter `renamefiles` with optionally, a list of files to rename.
...
* If you want to list only a group of files, you can pass them as an argument. eg: `renamefiles *.mp4`
* If you have an `$EDITOR` environment variable set, renamefiles will use its value by default.
* If you are inside a Git directory, renamefiles will use `git mv` (instead of `mv`) to rename the files.
